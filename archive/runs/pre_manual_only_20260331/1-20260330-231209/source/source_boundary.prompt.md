      ...
      "sources": [
        {
          "resource_id": "main",
          "role": "textbook",
          "query": "국가기관이 하는 일 — 법원의 구성과 하는 일 파악하기",
          "candidate_pages": [
            52,
            73,
            83
      ...
      "sources": [
        {
          "resource_id": "main",
          "role": "textbook",
          "query": "국가기관이 하는 일 — 권력 분립의 의미와 중요성 탐구하기",
          "candidate_pages": [
            70,
            71,
            87
      ...
      "sources": [
        {
          "resource_id": "main",
          "role": "textbook",
          "query": "민주주의와 미디어 — 미디어의 정보 제공 역할 알아보기",
          "candidate_pages": [
            7,
            103,
            105
      ...
      "sources": [
        {
          "resource_id": "main",
          "role": "textbook",
          "query": "민주주의와 미디어 — 미디어의 내용을 비판적으로 분석해야 하는 까 닭 알아보기",
          "candidate_pages": [
            7,
            90,
            101
      ...
      "sources": [
        {
          "resource_id": "main",
          "role": "textbook",
          "query": "민주주의와 미디어 — 미디어를 올바르게 이용하는 방법 알아보기",
          "candidate_pages": [
            7,
            90,
            103
      ...
      "sources": [
        {
          "resource_id": "main",
          "role": "textbook",
          "query": "2단원 정리 — [단원 마무리] 나만의 누리집 완성하기 / 창의·융 합 사고력 쑥쑥",
          "candidate_pages": [
            7,
            49,
            105
      ...
      "sources": [
        {
          "resource_id": "main",
          "role": "textbook",
          "query": "지구본과 지도로 보는 세계 — 지구본의 특징 살펴보기",
          "candidate_pages": [
            108,
            110,
            131
      ...
      "sources": [
        {
          "resource_id": "main",
          "role": "textbook",
          "query": "지구본과 지도로 보는 세계 — 디지털 공간 영상 정보의 의미 알아보기",
          "candidate_pages": [
            117,
            119,
            131
      ...
      "sources": [
        {
          "resource_id": "main",
          "role": "textbook",
          "query": "지구본과 지도로 보는 세계 — 위도와 위선의 의미 알아보기",
          "candidate_pages": [
            110,
            129,
            131
      ...
      "sources": [
        {
          "resource_id": "main",
          "role": "textbook",
          "query": "지구본과 지도로 보는 세계 — 경도와 경선의 의미 알아보기",
          "candidate_pages": [
            108,
            110,
            131
      ...
      "sources": [
        {
          "resource_id": "main",
          "role": "textbook",
          "query": "지구본과 지도로 보는 세계 — 위도와 경도를 이용해 위치를 표현하는 방법 살 펴보기",
          "candidate_pages": [
            110,
            129,
            131
      ...
      "sources": [
        {
          "resource_id": "main",
          "role": "textbook",
          "query": "세계의 대륙, 대양, 나라 — 우리나라의 위치 특징 파악하기",
          "candidate_pages": [
            132,
            137,
            149
      ...
      "sources": [
        {
          "resource_id": "main",
          "role": "textbook",
          "query": "세계의 대륙, 대양, 나라 — 북아메리카와 남아메리카 주요 나라들의 위치 알아보기",
          "candidate_pages": [
            139,
            141,
            143
      ...
      "sources": [
        {
          "resource_id": "main",
          "role": "textbook",
          "query": "세계의 대륙, 대양, 나라 — 아프리카 주요 나라들의 위치 알아보기",
          "candidate_pages": [
            139,
            141,
            145
      ...
      "sources": [
        {
          "resource_id": "main",
          "role": "textbook",
          "query": "3단원 정리 — [단원 마무리] 나만의 누리집 완성하기 / 창의·융 합 사고력 쑥쑥",
          "candidate_pages": [
            7,
            49,
            105
  ...
  "resources": [
    {
      ...
      "pages": [
        ...
        {
          "page": 73,
          "excerpt": "민주 국가에서 나랏일을 하는 ㄱ ㅎ , ㅎ ㅈ ㅂ , ㅂ ㅇ 을/를 국가기관이라고 한다. 한 문장 정리 법원 3 이곳은 우리나라 최고 법원인 대법원이야. 가운데 건물은 법원의 독립을, 양옆의 건물은 정의와 형평을 상징해. 이곳은 행정부 기관들이 자리한"
        },
        {
          "page": 75,
        ...
        {
          "page": 83,
          "excerpt": "증인 비판적 사고력 위 재판 모습을 보고, 물음에 답해 봅시다. 재판을 통해 법원의 역할 알아보기 스스로 해 보기 문제 해결력 및 의사 결정력 법을 어긴 사람을 처벌하는 재판 5 ‌\u0007피고인이 나물의 원산지를 속여 부당한 이득을 얻었지만, 초범 이고 죄"
        },
        {
          "page": 87,
          "excerpt": "민주 국가에서 국가 권력을 서로 독립된 기관이 나누어 맡도록 하는 것을 권력 분립이라고 한다. 우리나라는 국회, 행정부, 법원이 권력을 나누어 행사 하는데, 이를 삼권 분립이라고 한다. 삼권 분립을 통해 국가의 권력이 한 기관 에 집중되지 않도록 하고"
        },
        {
          "page": 89,
        ...
        {
          "page": 101,
          "excerpt": "정보 활용 능력 비판적 사고력 1 \u0007다음 신문 기사에서 비판적으로 분석해야 할 부분을 모두 골라 ◯표를 하고, 그렇게 생각한 까닭을 이야기해 봅시다. 미디어의 내용을 비판적으로 분석하기 스스로 해 보기 2 \u0007예시를 참고해 활동 자료7 의 검증 붙임딱지"
        },
        {
          "page": 103,
          "excerpt": "다음 내용이 옳으면 ◯표를, 틀리면 ×표를 선택해 오늘의 점심 식단을 찾아봅시다. 미디어를 올바르게 이용하려는 노력은 국가만 하면 된다. 미디어에서는 잘못된 정보가 무분별하게 퍼지기도 한다. 미디어의 내용은 비판적으로 받아들여야 한다. 미디어의 정보는"
        ...
        {
          "page": 110,
          "excerpt": "세계를 표현하는 다양한 공간 자료의 특징을 설명할 수 있어요. ‌\u0007다양한 공간 자료를 활용해 세계의 기초적인 지리 정보를 찾을 수 있어요. 위도와 경도의 의미를 이해하고, 이를 활용해 위치를 표현할 수 있어요. 이 주제를 배우면 나는 지구본과 지도로 "
        },
        {
          "page": 117,
          "excerpt": "미국 브라질 필리핀 칠레 페루 이집트 알제리 말리 차드수단 사우디 아라비아 튀르키예 타이 카자흐스탄 우크라이나 이란 뉴질랜드 인도 오스트레일리아 몽골 러 시 아 중국 캐 나 다 아르헨티나 멕시코 인도네시아 독일 프랑스 마다가스카르 소말리아 앙골라 콩고"
        },
        {
          "page": 119,
          "excerpt": "디지털 공간 영상 정보는 지구의 모습을 실감 나게 보여 준다. 또한 계속해서 변화 하는 공간 정보가 반영되기 때문에 세계 곳곳의 최신 정보를 확인하기에 좋다. 디지털 공간 영상 정보는 1980년부터 약 40년간의 위성 사진을 저장하고 있다. 그래서 시"
        },
        {
          "page": 129,
          "excerpt": "정보 활용 능력 위도와 경도를 이용해 위치 표현하기 스스로 해 보기 위도와 경도를 이용하면 지구상에서의 ㅇ ㅊ 을/를 알 수 있다. 한 문장 정리 다양한 공간 자료를 이용해 여러 나라의 위치를 알아봅시다. 1 \u0007다음 조건에 위치하는 나라를 찾아 써 봅"
        },
        {
          "page": 131,
          "excerpt": "옳은 문장의 번호를 순서대로 써서 우주의 여행 준비물을 챙겨 봅시다. 이번 주제에서 배운 내용을 정리하며 우리가 행복이를 만날 수 있는 길을 찾아봅시다. 1 ‌\u0007세계지도는 세계 여러 나라의 위치, 거리, 영토 모양 등을 비교적 정확하게 나타낼 수 있다"
        },
        {
          "page": 132,
        ...
        {
          "page": 137,
          "excerpt": "1 \u0007다음과 같은 방법으로 우리나라의 위치를 설명해 봅시다. 우리나라는 ㅇ ㅅ ㅇ 대륙의 동쪽에 있으며, ㅌ ㅍ ㅇ 과/와 맞닿아 있다. 한 문장 정리 정보 활용 능력 우리나라의 위치와 영토 특징 설명하기 스스로 해 보기 124° 42° 44° 40°"
        },
        {
          "page": 139,
        ...
        {
          "page": 149,
          "excerpt": "우주가 ‘세계 퀴즈 대회ʼ에서 우승할 수 있도록 정답을 찾아봅시다. 이번 주제에서 배운 내용을 정리하며 우리가 행복이를 만날 수 있는 길을 찾아봅시다. 주제마무리 1 세계에서 가장 넓은 바다는 대서양이다.\b ( ◯ , X ) 2 ‌\u0007우리나라는 유럽의 "
        },
        {
          "page": 156,
